...
using RequestReceiver.Service.Services;
using System;
using System.Collections.Generic;
using System.Linq;

namespace RequestReceiver.Service.UnitTest.Services
{
    public class UTOrderService
    {
        ...
        public void UTOrderService_Add()
        {
            ...
            var ex = Assert.Throws<RequestReceiver.Domain.Error.ApplicationException>(() => _orderService.Add(model));
            ...
            ex = Assert.Throws<RequestReceiver.Domain.Error.ApplicationException>(() => _orderService.Add(model));
        ...
        public void UTOrderService_Put()
        {
            ...
            var ex = Assert.Throws<RequestReceiver.Domain.Error.ApplicationException>(() => _orderService.Update(model));
            Assert.IsTrue(ex != null && ex.Errors.Any(x => x.Message.Equals("Numero deve ser preenchido.")) && ex.Errors.Any(x => x.Message.Equals("Cliente deve ser preenchido.")));
